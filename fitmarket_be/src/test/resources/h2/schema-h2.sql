...
CREATE TABLE orders (
    ...
    address_id               BIGINT NOT NULL,
    address_snapshot         VARCHAR(2000) NOT NULL,
    items_snapshot           VARCHAR(2000) NULL,
    user_id                  BIGINT NOT NULL,
...
CREATE TABLE order_return_exchanges (
    ...
    CONSTRAINT fk_order_return_exchanges_order FOREIGN KEY (order_id) REFERENCES orders (id) ON DELETE CASCADE
);
