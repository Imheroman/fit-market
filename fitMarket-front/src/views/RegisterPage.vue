                        ...
                        <div class="space-y-5">
                            <div>
                                <label for="register-email"
                                       class="block text-sm font-semibold text-gray-700">이메일</label>
                                <input
                                    id="register-email"
                                    v-model="form.email"
                                    type="email"
                            ...
                            <div>
                                <label for="register-password-confirm"
                                       class="block text-sm font-semibold text-gray-700">비밀번호 확인</label>
                                <input
                                    ...
                                    class="mt-2 w-full rounded-2xl border border-gray-200 px-4 py-3 focus:border-green-500 focus:ring-2 focus:ring-green-100"
                                />
                                <p v-if="passwordMismatchMessage" class="mt-1 text-sm text-red-500">
                                    {{ passwordMismatchMessage }}</p>
                                <p v-else-if="errors.confirmPassword" class="mt-1 text-sm text-red-500">
                            ...
                            <div>
                                <label for="register-phone" class="block text-sm font-semibold text-gray-700">휴대폰
                                    번호</label>
                                <input
                                    id="register-phone"
                                    v-model="form.phone"
