        ...
        <section class="bg-white border border-green-100 rounded-3xl shadow-xl p-8">
          ...
          <form class="mt-10 space-y-6" @submit.prevent="handleSubmit">
            ...
            <div class="space-y-5">
              ...
              <div>
                <label for="login-password" class="flex items-center justify-between text-sm font-semibold text-gray-700">
                  비밀번호
          ...
          <div class="mt-8 text-sm text-center text-gray-600">
            <p>아직 회원이 아니신가요?</p>
            <button type="button" class="mt-2 font-semibold text-green-600 hover:text-green-700" @click="goToSignup">
              1분만에 회원가입하기
            </button>
          </div>
        </section>
