                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex items-center gap-4 mb-4">
                                    <div class="flex items-center border border-green-200 rounded-lg">
                                        ...
                                        <div class="px-4 py-1 font-semibold min-w-[40px] text-center">{{
                                                item.quantity
                                            }}
                                        </div>
                                        <button
                                ...
                                <div class="flex gap-4 text-sm">
                                    <span class="text-gray-600">칼로리: <strong>{{
                                            formatNumber(item.calories * item.quantity)
                                        }}</strong>kcal</span>
                                    <span class="text-gray-600">단백질: <strong class="text-green-600">{{
                                            formatNumber(item.protein * item.quantity)
                                        }}g</strong></span>
                                </div>
                            </div>
                        ...
                        <div class="space-y-4 mb-6">
                            ...
                            <div class="border-t border-green-100 pt-4 flex justify-between text-lg">
                                ...
                                <span class="font-bold text-green-600">{{
                                        formatNumber(displayTotalPrice + shippingFee)
                                    }}원</span>
                            </div>
                        </div>

                        <div
                            class="bg-gradient-to-br from-green-50 to-white border border-green-100 rounded-lg p-4 mb-6">
