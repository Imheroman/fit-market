<template>
    <div class="min-h-screen bg-gradient-to-b from-green-50 to-white">
        ...
        <!-- Hero Section -->
        <section
            class="relative overflow-hidden bg-gradient-to-br from-green-500 via-green-600 to-green-700 text-white">
            ...
            <div class="relative container mx-auto px-4 py-16 md:py-24">
                <div class="max-w-2xl">
          <span
              class="inline-block mb-4 px-3 py-1 text-sm font-medium bg-white/20 text-white border border-white/30 rounded-full backdrop-blur-sm">
            신선한 건강식 배송
          </span>
        ...
        <section class="container mx-auto px-4 py-4">
            <div class="grid grid-cols-1 lg:grid-cols-[70%,30%] gap-3">
                ...
                <div class="border border-green-100 bg-white rounded-xl px-3 py-3">
                    ...
                    <div
                        class="flex gap-1.5 overflow-x-auto pb-1 scrollbar-thin scrollbar-thumb-green-200 scrollbar-track-transparent">
                        <button
        ...
        <section class="container mx-auto px-4 py-16">
            <div class="grid md:grid-cols-3 gap-8">
                <div
                    class="border border-green-100 bg-gradient-to-br from-green-50 to-white rounded-xl p-6 text-center">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center mx-auto mb-4">
